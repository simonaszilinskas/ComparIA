...
>
  <aside class="bg-light-grey py-3 md:py-4 px-4 md:px-6">
    <form class="gap-3 lg:flex-row lg:items-start flex flex-col flex-wrap">
      <div class="lg:w-[240px] lg:shrink-0">
        <Search
      ...
      <div class="gap-3 md:flex-row lg:flex-nowrap flex flex-col flex-wrap">
